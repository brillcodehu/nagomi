...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Pilates illustration ghost */}
      <div
        className="absolute inset-0 pointer-events-none hero-fade-in"
        aria-hidden="true"
      >
        <div
          ...
          style={{
            ...
            opacity: 0.025,
            maskImage: "radial-gradient(ellipse 80% 70% at 50% 55%, black, transparent 70%)",
            WebkitMaskImage: "radial-gradient(ellipse 80% 70% at 50% 55%, black, transparent 70%)",
          }}
        />
      </div>
      ...
      {/* Line-art ghost */}
      <div
        className="absolute inset-0 pointer-events-none hero-fade-in-delayed"
        aria-hidden="true"
      >
        <div
          ...
          style={{
            ...
            backgroundRepeat: "no-repeat",
            backgroundPosition: "center",
            filter: "invert(1) sepia(1) saturate(0.35) hue-rotate(5deg) brightness(0.85) contrast(1.5)",
            mixBlendMode: "screen" as const,
            opacity: 0.069,
            maskImage: "radial-gradient(ellipse 80% 70% at 50% 55%, black 15%, transparent 65%)",
            WebkitMaskImage: "radial-gradient(ellipse 80% 70% at 50% 55%, black 15%, transparent 65%)",
          }}
        />
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none hidden lg:block" aria-hidden="true">
        <div className="absolute right-[2%] top-[8%] w-[340px] h-[340px] xl:w-[420px] xl:h-[420px] hero-fade-in-delayed">
          <div className="hero-botanical-sway w-full h-full">
            <MonsteraLeaf className="w-full h-full text-primary/[0.10] rotate-[-15deg]" />
          </div>
        </div>
        <div className="absolute left-[-2%] bottom-[10%] w-[200px] h-[200px] xl:w-[260px] xl:h-[260px] hero-fade-in-delayed">
        ...
        <div className="absolute left-[15%] top-[18%] w-[60px] h-[60px] xl:w-[80px] xl:h-[80px] hero-fade-in-delayed">
          <div className="hero-botanical-float w-full h-full">
            <SimpleLeaf className="w-full h-full text-primary/[0.12] rotate-[45deg]" />
          </div>
        </div>
        <div className="absolute right-[20%] bottom-[22%] w-[40px] h-[40px] hero-fade-in-delayed">
      ...
      {/* Content - TEXT IS VISIBLE IMMEDIATELY, no JS needed for LCP */}
      <motion.div
      ...
      >
        <div className="w-full max-w-[1400px] mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-[1fr,auto] gap-12 lg:gap-16 items-center">
            {/* Text - visible immediately via CSS, animated with CSS keyframes */}
            <div className="max-w-2xl hero-content-reveal">
              ...
              <h1 className="mb-8">
                <span className="block overflow-hidden">
                  <span className="block font-[family-name:var(--font-playfair)] text-[clamp(3rem,8.5vw,8rem)] font-medium leading-[0.9] tracking-[-0.03em] text-background hero-text-reveal">
                    Találj rá
                  </span>
                </span>
                <span className="block overflow-hidden mt-1">
                  <span className="block font-[family-name:var(--font-playfair)] text-[clamp(3rem,8.5vw,8rem)] font-medium leading-[0.9] tracking-[-0.03em] text-background/85 italic hero-text-reveal-2">
                    önmagadra.
                  </span>
                </span>
              </h1>
            ...
            >
              <div className="relative hero-circle-entry">
                <div className="hero-circle-spin">
                  <svg viewBox="0 0 300 300" className="w-[220px] h-[220px] xl:w-[280px] xl:h-[280px]">
                    <defs>
                      <path id="heroCirclePath" d="M 150,150 m -115,0 a 115,115 0 1,1 230,0 a 115,115 0 1,1 -230,0" />
                    </defs>
                    <text
